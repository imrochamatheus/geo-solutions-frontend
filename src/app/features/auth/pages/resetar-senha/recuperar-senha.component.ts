...
export class RecuperarSenhaComponent {
  ...
  enviar() {
    if (!this.segundaEtapa && this.recuperarForm.valid) {
      ...
      fetch("https://localhost:7080/api/Users/forgot-password", {
        method: "POST",
        headers: {
    ...
    else if (this.segundaEtapa && this.recuperarForm.valid && this.userID !== null) {
      ...
      this.http.post<any>(`https://localhost:7080/api/Users/verify-code/${this.userID}`, payload).subscribe({
        next: (res) => {
